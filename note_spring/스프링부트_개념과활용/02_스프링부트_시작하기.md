...
![image-20200824152518507](images/image-20200824152518507.png) 
...
![image-20200824153003571](images/image-20200824153003571.png)
...
<img src="images/image-20200824153244796.png" alt="image-20200824153244796" style="zoom:50%;" />
...
2. maven, gradle 프로젝트, 스프링 부트 버전, java 버전, 의존성 추가 > [GENERATE] > zip 아카이브 파일이 다운로드 된다.
   ...
   <img src="images/image-20200824160106212.png" alt="image-20200824160106212" style="zoom: 50%;" />
...
* 스프링 부트에서 딱 하나 추천하는 **main Application** 클래스의 위치
  ...
  * 이 패키지(dev.solar)부터 시작해서 패키지 하위의 모든 패키지 않의 모든 빈을 등록한다.
    ...
    ![image-20200824164503982](images/image-20200824164503982.png)
